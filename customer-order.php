            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $statement1 = $pdo->prepare("SELECT * FROM credit_card WHERE payment_id=?");
                                            $statement1->execute(array($row['payment_id']));
                                            $result1 = $statement1->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result1 as $row1) {
                                                echo 'Address: '.$row1['address'];
                                                echo '<br>Phone: '.$row1['phone'];
                                                echo '<br>Card Number: '.$row1['card_number'];
                                                echo '<br><br>';
                                            }
                                            ?>
                                        </td>
										...
										<td><a href="delete-order.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                                    </tr>
                                    <?php
                                } 
                                ?>                               
